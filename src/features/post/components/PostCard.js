    ...
    return (
		<div className="PostDetailCard">
			<div className="PostDetailTop">
				...
				<span id={`${post?.postId} ${post?.username} ${post?.postKey}`} onClick={(event) => toggleUserPostSettingsModal(event)} style={{fontSize: "3rem"}} className="material-symbols-outlined PostSettings">more_horiz</span>
			</div>
